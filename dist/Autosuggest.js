...
var Autosuggest = /*#__PURE__*/ (function (_Component) {
  ...
  function Autosuggest(_ref2) {
    ...
    _defineProperty(
      ...
      function (event, _ref3) {
        ...
        _this.updateHoveredSuggestion(sectionIndex, itemIndex);
    ...
    _defineProperty(_assertThisInitialized(_this), 'onBlur', function () {
      ...
      var hoveredSuggestion = _this.getHoveredSuggestion();
  ...
  _createClass(Autosuggest, [
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps, prevState) {
        var _this$props4 = this.props,
          ...
          onSuggestionHovered = _this$props4.onSuggestionHovered,
        ...
        if (onSuggestionHovered) {
          var hoveredSuggestion = this.getHoveredSuggestion();
    ...
    {
      key: 'updateHoveredSuggestion',
      value: function updateHoveredSuggestion(sectionIndex, suggestionIndex) {
        var _this2 = this;
        ...
        this.setState(function (state) {
          ...
          return {
            ...
            highlightedSuggestion:
              suggestionIndex === null
                ? null
                : _this3.getSuggestion(sectionIndex, suggestionIndex),
    ...
    {
      key: 'resetHoveredSuggestion',
      value: function resetHoveredSuggestion() {
        this.setState(function () {
          return {
            hoveredSuggestion: null,
            hoveredSuggestionIndex: null,
    ...
    {
      key: 'getHoveredSuggestion',
      value: function getHoveredSuggestion() {
        var hoveredSuggestion = this.state.hoveredSuggestion;
    ...
    },
    {
      ...
      value: function render() {
        ...
        var _this$state2 = this.state,
          ...
          hoveredSuggestionIndex = _this$state2.hoveredSuggestionIndex,
        ...
        var autowhateverInputProps = _objectSpread({}, inputProps, {
          onFocus: function onFocus(event) {
            if (
              ...
              !_this4.justClickedOnSuggestionsContainer
            ) {
          ...
          onBlur: function onBlur(event) {
            if (_this4.justClickedOnSuggestionsContainer) {
              _this4.input.focus();

              return;
            }

            _this4.blurEvent = event;
          ...
          onChange: function onChange(event) {
            ...
            _this4.maybeCallOnChange(event, value, 'type');

            if (_this4.suggestionsContainer) {
              _this4.suggestionsContainer.scrollTop = 0;
            }
            ...
            switch (keyCode) {
              ...
              case 38:
                ...
                if (isCollapsed) {
                  ...
                  if (newHighlightedItemIndex === null) {
                    ...
                    newValue = _this4.getSuggestionValueByIndex(
                ...
                _this4.justPressedUpDown = true;
                setTimeout(function () {
                  _this4.justPressedUpDown = false;
                });
                break;
              // Enter
              ...
              case 13: {
                ...
                if (highlightedSuggestion != null) {
                  ...
                  _this4.maybeCallOnChange(event, _newValue, 'enter');
              ...
              case 27: {
                ...
                if (valueBeforeUpDown === null) {
                  ...
                  if (!willCloseSuggestions) {
                    ...
                    _this4.maybeCallOnChange(event, _newValue2, 'escape');
                  ...
                  _this4.maybeCallOnChange(event, valueBeforeUpDown, 'escape');
                }
...
_defineProperty(Autosuggest, 'propTypes', {
  ...
  onSuggestionHovered: _propTypes['default'].func,
