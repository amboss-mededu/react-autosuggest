            ...
            },
            {
              ...
              value: function () {
                var e = this,
                  ...
                  a = t.hoveredItemIndex,
                  l = t.getItemId,
                  g = t.theme,
                  f = t.keyPrefix,
                  p = null === s ? f : ''.concat(f, 'section-').concat(s, '-'),
                  h = 'function' == typeof o;
                return r.a.createElement(
                  ...
                  n.map(function (t, n) {
                    var f = 0 === n,
                      d = n === c,
                      y = n === a,
                      m = ''.concat(p, 'item-').concat(n),
                      v = h ? o({ sectionIndex: s, itemIndex: n }) : o,
                      S = (function (e) {
                        for (var t = 1; t < arguments.length; t++) {
                          var n = null != arguments[t] ? arguments[t] : {};
                          t % 2
                    ...
                    return (
                      d && (S.ref = e.storeHighlightedItemReference),
                      r.a.createElement(
                        T,
                        M({}, S, {
                          sectionIndex: s,
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var t = this.theme,
                    ...
                    g = n.hoveredItemIndex,
                    f = n.itemProps;
                  return i.map(function (n, i) {
                    var p = 'react-autowhatever-'.concat(o, '-'),
            ...
            return (
              ...
              ye(fe(t), 'onBlur', function () {
                ...
                t.setState({
                  ...
                  i && i(t.blurEvent, { hoveredSuggestion: u });
              }),
              ye(fe(t), 'onSuggestionMouseLeave', function (e) {
                t.resetHoveredSuggestion(),
                  t.justSelectedSuggestion &&
                    e.target === t.pressedSuggestion &&
                    (t.justSelectedSuggestion = !1);
              }),
          ...
          return (
            ...
            (o = [
              ...
              },
              {
                ...
                value: function (e, t) {
                  var n = this.props,
                    ...
                    i = n.onSuggestionHovered,
                    s = n.highlightFirstSuggestion;
                  if (!u()(o, e.suggestions) && o.length > 0 && s)
                    this.highlightFirstSuggestion();
                  else {
                    if (r) {
                      var c = this.getHighlightedSuggestion();
                      c != t.highlightedSuggestion && r({ suggestion: c });
                    }
                    if (i) {
                      var a = this.getHoveredSuggestion();
                      null !== a && i({ suggestion: a });
                    }
                  }
                },
              },
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  this.setState(function () {
                    return {
                      hoveredSuggestionIndex: t,
                      hoveredSuggestion:
                        null === t ? null : n.getSuggestion(e, t),
                    };
                  });
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  var e = this.state.hoveredSuggestion;
              ...
              },
              {
                ...
                value: function () {
                  var e = this,
                    ...
                    m = y.isFocused,
                    v = y.isCollapsed,
                    S = y.highlightedSectionIndex,
                    b = y.highlightedSuggestionIndex,
                    I = y.hoveredSuggestionIndex,
